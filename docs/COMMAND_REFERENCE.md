...
Exit codes: `0` success, `1` runtime failure, `2` usage/configuration or stopped hearing, and `3` integrity/authorization failure. All commands accept `--config`, `--storage-dir`, `--identity`, and `--access-policy` where applicable.
