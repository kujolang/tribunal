...
- Ending implementation revision: `f8febe9` (directory traversal follow-up); runtime-target update: `0ab868d072a3ee536f28858f9dbdd2f2aefeec4e`. This report is a subsequent documentation commit; resolve its containing revision with `git log -1 -- docs/audits/repository-hardening-2026-09-26.md`.
